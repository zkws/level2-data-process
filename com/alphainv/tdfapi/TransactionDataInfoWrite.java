...
//              接收到深交所股票成交数据后，将成交单对应的原始买单卖单从当前的买单和卖单中减去
                        if(!singleStockCodeNum.startsWith("6")){
                            ...
                            Long saleOrderPrice = orderPriceArray[askOrderNum];
                            if (null!=buyOrderPrice&&null!=saleOrderPrice){
                                Object[] orderInfoArrayTB = new Object[3];
                                orderInfoArrayTB[0]=singleStockCodeNum;
                                orderInfoArrayTB[1]=-1*buyOrderPrice*volumeNum;
                                orderInfoArrayTB[2]=buyOrderPrice;

                                Object[] orderInfoArrayTS = new Object[3];
                                orderInfoArrayTS[0]=singleStockCodeNum;
                                orderInfoArrayTS[1]=-1*saleOrderPrice*volumeNum;
                                orderInfoArrayTS[2]=saleOrderPrice;
                                try {
