...
//        long statDateLong = statDate.getTime();
        ...
        String continuousStartTimeStr = ymdStr+"-093000";
        Date continuousStartTime = null;
        try {
            continuousStartTime = fullDF.parse(continuousStartTimeStr);
                ...
                if (marketDataInfoInstance!=null){
                    ...
                    if (singleStockCodeNum.startsWith("6")||singleStockCodeNum.startsWith("0")||singleStockCodeNum.startsWith("3")){
                        ...
                        if (stkChannelCode!=null){
                            ...
                            if (nowDate.before(continuousStartTime)){
                                recentPrice = preClosePrice;
                            }
